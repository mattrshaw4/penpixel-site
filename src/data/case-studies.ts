...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    headline: 'Entity Resolution Delivers #1 Ranking',
    sub: 'How Penpixel Creative disentangled TAG\'s brand entity from search and LLM conflation, secured the #1 position for its core query, and expanded search authority into three new verticals.',
    metaTitle: 'Case Study: #1 Ranking via Entity Resolution for TAG | Penpixel Creative',
    metaDescription: 'Entity resolution for The Alexander Group. Delivered #1 ranking for the core query and search authority across three new verticals within six months.',
    homeMetric: { value: '#1', label: 'ranking via entity resolution' },
    challengeIntro: 'The Alexander Group (TAG), an executive recruitment firm, deployed a visually polished website that lacked underlying technical SEO architecture. Search engines and LLMs conflated TAG with unrelated entities sharing the same name, suppressing organic discovery and creating three business liabilities:',
    challenges: [
      { k: 'Entity Conflation', v: 'Neither traditional search crawlers nor LLMs could differentiate TAG from other businesses sharing the "Alexander Group" name. This identity collision stripped TAG of brand clout and redirected prospective enterprise clients to competitors.' },
      { k: 'Content Architecture Gaps', v: 'Content was written without keyword research, entity mapping, internal link logic, or schema markup. Pages failed to inform discovery engines or address shifting user search habits toward LLM interfaces.' },
      { k: 'Vertical Lock-In', v: 'TAG\'s legacy search footprint bound its reputation strictly to legal recruiting, preventing the firm from capturing market share in adjacent high-growth verticals.' },
    ],
    strategyTitle: 'Entity Resolution & Semantic Architecture',
    strategyIntro: 'A site designed solely for visual appeal fails when search engines and LLMs attempt to index its purpose. Without structural schema, defined entity associations, and semantic linking, machine systems treat brand claims as unverified noise or confuse them with better-structured third-party data. Penpixel Creative implemented a multi-stage technical and content intervention:',
    strategy: [
      { k: 'AI-Search Readiness Audit', v: 'Executed a comprehensive diagnostic to identify missing schema markup, metadata deficiencies, indexing errors, and structural rendering gaps.' },
      { k: 'Technical & Entity Remediation', v: 'Implemented structured organization schema, canonical tags, and metadata to establish a distinct, machine-readable identity for TAG.' },
      { k: 'Semantic Keyword Mapping', v: 'Rebuilt page structures and internal linking systems to map content to high-intent queries and LLM retrieval patterns.' },
      { k: 'Multi-Industry Content Strategy', v: 'Established an editorial strategy targeting semantic clusters outside legal recruitment: life sciences and healthcare, non-profit, and energy.' },
    ],
    impactTitle: 'Measured Outcomes',
    impacts: [
      { value: '#1', k: 'Search Dominance', v: 'Reached the #1 ranking for the primary focus term "global executive search firm houston" within six months of implementation.' },
      { value: '3', k: 'New Verticals', v: 'Established search authority and inbound lead flow across life sciences and healthcare, non-profit, and energy sectors.' },
    ],
    quote: 'A visually polished site with no machine-readable architecture is invisible to the systems enterprise buyers now use. Once TAG\'s entity structure was resolved, the #1 ranking followed.',
    sidebarTitle: 'Resolution Metrics',
    sidebar: [
      { value: '#1', label: 'Ranking for the core query "global executive search firm houston" within six months.' },
      { value: '3 months', label: 'Time to entity disambiguation across search indexes and LLM outputs.' },
      { value: '3 verticals', label: 'New market authority established in life sciences, non-profit, and energy.' },
      { value: 'Resolved', label: 'Entity conflation eliminated; TAG parsed distinctly by search engines and LLMs.' },
    ],
    ctaEyebrow: 'Resolve Your Entity Structure',
    ctaTitle: 'Is Your Brand Getting Confused with Someone Else?',
    ctaBody: 'When platforms deploy without machine-readable architecture, discovery systems make assumptions about your business, often confusing your brand with competitors or dropping it from search results. Book an AI-Search Readiness Audit to evaluate site architecture, eliminate entity conflation, and secure authority across search and AI systems.',
    ctaLabel: 'Book Your Audit',
  },
  {
    slug: 'joveo',
